package io.github.kischang.arduino.uploader.ArduinoUploader.Config;
...
public class Arduino {
    ...
    public Arduino(String model, McuIdentifier mcu, int baudRate, String preOpenResetBehavior, String postOpenResetBehavior, String closeResetBehavior, int sleepAfterOpen, int readTimeout, int writeTimeout, io.github.kischang.arduino.uploader.ArduinoUploader.Config.Protocol protocol) {
        Model = model;
        Mcu = mcu;
        BaudRate = baudRate;
    ...
    public Arduino(String model, McuIdentifier mcu, int baudRate, io.github.kischang.arduino.uploader.ArduinoUploader.Config.Protocol protocol) {
        Model = model;
        Mcu = mcu;
        BaudRate = baudRate;
        Protocol = protocol;
