...
public class SetDeviceProgrammingParametersRequest extends Request {
    public SetDeviceProgrammingParametersRequest(IMcu mcu) {
        io.github.kischang.arduino.uploader.ArduinoUploader.Hardware.Memory.IMemory flashMem = mcu.getFlash();
        io.github.kischang.arduino.uploader.ArduinoUploader.Hardware.Memory.IMemory eepromMem = mcu.getEeprom();
