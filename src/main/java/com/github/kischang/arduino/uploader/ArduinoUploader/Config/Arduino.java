...
public class Arduino {
    ...
    public Arduino(String model, McuIdentifier mcu, int baudRate, String preOpenResetBehavior, String postOpenResetBehavior, String closeResetBehavior, int sleepAfterOpen, int readTimeout, int writeTimeout, com.github.kischang.arduino.uploader.ArduinoUploader.Config.Protocol protocol) {
        Model = model;
        Mcu = mcu;
        BaudRate = baudRate;
    ...
    public Arduino(String model, McuIdentifier mcu, int baudRate, com.github.kischang.arduino.uploader.ArduinoUploader.Config.Protocol protocol) {
        Model = model;
        Mcu = mcu;
        BaudRate = baudRate;
        Protocol = protocol;
