package com.github.kischang.arduino.uploader.ArduinoUploader.BootloaderProgrammers.Protocols.STK500v2;
...
import com.github.kischang.arduino.uploader.ArduinoUploader.BootloaderProgrammers.Protocols.STK500v2.Messages.*;
...
import io.github.kischang.arduino.uploader.ArduinoUploader.BootloaderProgrammers.Protocols.STK500v2.Messages.*;
...
public class Stk500V2BootloaderProgrammer<E extends ISerialPortStream> extends ArduinoBootloaderProgrammer<E> {
	...
	public Stk500V2BootloaderProgrammer(com.github.kischang.arduino.uploader.ArduinoUploader.BootloaderProgrammers.SerialPortConfig serialPortConfig, IMcu mcu) {
...
//        var response = (TResponse) Activator.CreateInstance(typeof(TResponse));
		...
		if (retryCounter == maxRetries) {
			if (getLogger() != null)
				getLogger().trace("No MESSAGE_START found after ${} bytes!", maxRetries);
			return null;
		}
		...
		if (seqNumber != LastCommandSequenceNumber) {
			if (getLogger() != null){
				getLogger().warn("STK500V2 wrapper corrupted (Wrong sequence number: ${} - expected ${})!"
...
//        GetSyncResponse result = this.<GetSyncResponse>Receive();
	...
	public void InitializeDevice() {
		...
		if (getLogger() != null)
			getLogger().info("Retrieved software version: ${} (hardware) - ${}.${} (software).", hardwareVersion, softwareMajor, softwareMinor);
		if (getLogger() != null)
			getLogger().info("Parameter VTarget: ${}.", vTarget);
	}
